...
// 아래는 예시이며, 이미지 경로는 public/images/tarot-spread/ 폴더에 맞게 설정해야 합니다.
export const tarotDeck: TarotCard[] = [
  // Major Arcana
  {
    ...
    suit: 'major',
    number: 0,
    imageSrc: '/images/tarot-spread/00-TheFool.png',
    dataAiHint: 'fool 광대',
  ...
  },
  {
    ...
    suit: 'major',
    number: 1,
    imageSrc: '/images/tarot-spread/01-TheMagician.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 2,
    imageSrc: '/images/tarot-spread/02-TheHighPriestess.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 3,
    imageSrc: '/images/tarot-spread/03-TheEmpress.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 4,
    imageSrc: '/images/tarot-spread/04-TheEmperor.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 5,
    imageSrc: '/images/tarot-spread/05-TheHierophant.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 6,
    imageSrc: '/images/tarot-spread/06-TheLovers.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 7,
    imageSrc: '/images/tarot-spread/07-TheChariot.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 8,
    imageSrc: '/images/tarot-spread/08-Strength.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 9,
    imageSrc: '/images/tarot-spread/09-TheHermit.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 10,
    imageSrc: '/images/tarot-spread/10-WheelOfFortune.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 11,
    imageSrc: '/images/tarot-spread/11-Justice.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 12,
    imageSrc: '/images/tarot-spread/12-TheHangedMan.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 13,
    imageSrc: '/images/tarot-spread/13-Death.png',
    dataAiHint: 'death 죽음',
  ...
  },
  {
    ...
    suit: 'major',
    number: 14,
    imageSrc: '/images/tarot-spread/14-Temperance.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 15,
    imageSrc: '/images/tarot-spread/15-TheDevil.png',
    dataAiHint: 'devil 악마',
  ...
  },
  {
    ...
    suit: 'major',
    number: 16,
    imageSrc: '/images/tarot-spread/16-TheTower.png',
    dataAiHint: 'tower 탑',
  ...
  },
  {
    ...
    suit: 'major',
    number: 17,
    imageSrc: '/images/tarot-spread/17-TheStar.png',
    dataAiHint: 'star 별',
  ...
  },
  {
    ...
    suit: 'major',
    number: 18,
    imageSrc: '/images/tarot-spread/18-TheMoon.png',
    dataAiHint: 'moon 달',
  ...
  },
  {
    ...
    suit: 'major',
    number: 19,
    imageSrc: '/images/tarot-spread/19-TheSun.png',
    dataAiHint: 'sun 태양',
  ...
  },
  {
    ...
    suit: 'major',
    number: 20,
    imageSrc: '/images/tarot-spread/20-Judgement.png',
  ...
  },
  {
    ...
    suit: 'major',
    number: 21,
    imageSrc: '/images/tarot-spread/21-TheWorld.png',
    dataAiHint: 'world 세계',
  ...
  // Wands
  {
    ...
    suit: 'wands',
    number: 'ace',
    imageSrc: '/images/tarot-spread/Wands01.png',
  ...
  ...Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      ...
      suit: 'wands' as const,
      number: num,
      imageSrc: `/images/tarot-spread/Wands${num.toString().padStart(2, '0')}.png`,
  ...
  }),
  {
    ...
    suit: 'wands',
    number: 'page',
    imageSrc: '/images/tarot-spread/Wands11.png',
  ...
  },
  {
    ...
    suit: 'wands',
    number: 'knight',
    imageSrc: '/images/tarot-spread/Wands12.png',
  ...
  },
  {
    ...
    suit: 'wands',
    number: 'queen',
    imageSrc: '/images/tarot-spread/Wands13.png',
  ...
  },
  {
    ...
    suit: 'wands',
    number: 'king',
    imageSrc: '/images/tarot-spread/Wands14.png',
  ...
  // Cups
  {
    ...
    suit: 'cups',
    number: 'ace',
    imageSrc: '/images/tarot-spread/Cups01.png',
    dataAiHint: 'ace cups',
  ...
  ...Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      ...
      suit: 'cups' as const,
      number: num,
      imageSrc: `/images/tarot-spread/Cups${num.toString().padStart(2, '0')}.png`,
      dataAiHint: `cups ${num}`,
  ...
  }),
  {
    ...
    suit: 'cups',
    number: 'page',
    imageSrc: '/images/tarot-spread/Cups11.png',
  ...
  },
  {
    ...
    suit: 'cups',
    number: 'knight',
    imageSrc: '/images/tarot-spread/Cups12.png',
  ...
  },
  {
    ...
    suit: 'cups',
    number: 'queen',
    imageSrc: '/images/tarot-spread/Cups13.png',
  ...
  },
  {
    ...
    suit: 'cups',
    number: 'king',
    imageSrc: '/images/tarot-spread/Cups14.png',
  ...
  // Swords
  {
    ...
    suit: 'swords',
    number: 'ace',
    imageSrc: '/images/tarot-spread/Swords01.png',
  ...
  ...Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      ...
      number: num,
      imageSrc: `/images/tarot-spread/Swords${num.toString().padStart(2, '0')}.png`,
  ...
  }),
  {
    ...
    suit: 'swords',
    number: 'page',
    imageSrc: '/images/tarot-spread/Swords11.png',
  ...
  },
  {
    ...
    suit: 'swords',
    number: 'knight',
    imageSrc: '/images/tarot-spread/Swords12.png',
  ...
  },
  {
    ...
    suit: 'swords',
    number: 'queen',
    imageSrc: '/images/tarot-spread/Swords13.png',
  ...
  },
  {
    ...
    suit: 'swords',
    number: 'king',
    imageSrc: '/images/tarot-spread/Swords14.png',
  ...
  // Pentacles
  {
    ...
    suit: 'pentacles',
    number: 'ace',
    imageSrc: '/images/tarot-spread/Pentacles01.png',
  ...
  ...Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      ...
      number: num,
      imageSrc: `/images/tarot-spread/Pentacles${num.toString().padStart(2, '0')}.png`,
  ...
  }),
  {
    ...
    suit: 'pentacles',
    number: 'page',
    imageSrc: '/images/tarot-spread/Pentacles11.png',
  ...
  },
  {
    ...
    suit: 'pentacles',
    number: 'knight',
    imageSrc: '/images/tarot-spread/Pentacles12.png',
  ...
  },
  {
    ...
    suit: 'pentacles',
    number: 'queen',
    imageSrc: '/images/tarot-spread/Pentacles13.png',
  ...
  },
  {
    ...
    suit: 'pentacles',
    number: 'king',
    imageSrc: '/images/tarot-spread/Pentacles14.png',
