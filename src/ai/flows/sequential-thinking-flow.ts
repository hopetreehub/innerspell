...
export async function sequentialThinkingFlow(input: SequentialThinkingInput): Promise<SequentialThinkingOutput> {
  ...
  const flow = ai.defineFlow(
    ...
    async (flowInput) => {
      ...
      const taskList: string[] = JSON.parse(deconstructionResponse.text);
