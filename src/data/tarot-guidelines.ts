...
export const SPREAD_STYLE_COMBINATIONS: SpreadStyleCombination[] = [
  ...
  // 삼위일체 조망 x 영적 성장과 자기 성찰 - 새로운 풍성한 지침
  {
    id: 'trinity-view-spiritual-growth-reflection',
    spreadId: 'trinity-view',
    styleId: 'spiritual-growth-reflection',
    spreadName: '삼위일체 조망 (Trinity View)',
    styleName: '영적 성장과 자기 성찰',
    styleDescription: '내면의 영적 성장과 자기 이해를 깊이 있게 탐구하는 해석 방법',
    name: '삼위일체 조망 - 영혼의 여정과 자기 성찰',
    description: '시간의 흐름을 영혼의 진화 과정으로 해석하며, 각 단계에서 얻는 영적 교훈과 내면의 성장을 깊이 있게 탐구',
    positions: [
      {
        positionId: 'past',
        positionName: '과거 - 영혼의 씨앗 (Soul Seeds)',
        interpretationFocus: '과거 경험에 담긴 영적 교훈과 카르마적 의미, 현재 영혼 상태의 뿌리가 된 영적 씨앗들을 탐구',
        keyQuestions: [
          '이 과거 경험이 나의 영혼에 심어준 가장 깊은 가르침은 무엇인가?',
          '어떤 카르마적 패턴이나 영적 숙제가 이 시기에 형성되었는가?',
          '나의 영혼이 이 경험을 통해 어떤 성장을 추구했던 것인가?',
          '현재의 나에게 여전히 영향을 주는 영적 상처나 축복은 무엇인가?',
          '이 카드가 보여주는 과거의 그림자는 어떻게 빛으로 변환될 수 있는가?'
        ],
        styleSpecificNotes: '단순한 과거 사건이 아닌 영혼의 성장 관점에서 해석. 카르마적 교훈, 영적 씨앗, 의식의 진화 측면을 중점적으로 다룸',
        timeframe: '과거생 포함 영혼의 기억과 이생에서의 영적 형성기'
      },
      {
        positionId: 'present',
        positionName: '현재 - 의식의 거울 (Mirror of Consciousness)',
        interpretationFocus: '현재 순간 영혼의 상태와 의식 수준, 지금 이 시점에서 직면한 영적 과제와 성장의 기회를 깊이 성찰',
        keyQuestions: [
          '지금 이 순간 나의 영혼은 어떤 메시지를 전하고 있는가?',
          '현재 내가 경험하는 상황의 영적 의미와 목적은 무엇인가?',
          '나의 의식이 확장되고 있는 영역과 여전히 어둠 속에 있는 영역은?',
          '지금 내 안에서 통합되기를 기다리는 빛과 그림자는 무엇인가?',
          '이 카드가 보여주는 현재의 영적 선물과 도전은 각각 무엇인가?',
          '내면의 직감과 고차원적 자아가 지금 나에게 전하는 안내는?'
        ],
        styleSpecificNotes: '현재를 단순한 상황이 아닌 의식 진화의 특별한 순간으로 해석. 영적 깨달음, 내면 통합, 의식 확장의 기회로 접근',
        timeframe: '현재 순간의 영적 상태와 즉시적 의식 변화의 가능성'
      },
      {
        positionId: 'future',
        positionName: '미래 - 영혼의 꽃피움 (Soul Blossoming)',
        interpretationFocus: '영혼의 성장 방향과 의식 진화의 다음 단계, 내면의 잠재력이 현실화되는 미래의 모습과 영적 비전',
        keyQuestions: [
          '나의 영혼이 향해가는 진화의 다음 단계는 어떤 모습인가?',
          '현재의 영적 성장이 완성되었을 때 어떤 새로운 나를 만나게 될까?',
          '이 여정을 통해 내가 세상에 기여할 수 있는 영적 선물은 무엇인가?',
          '미래의 나는 현재의 도전을 어떤 지혜로 바라볼 것인가?',
          '내 영혼의 목적과 사명이 구체적으로 어떻게 펼쳐질 것인가?',
          '이 카드가 약속하는 영적 성취와 의식의 꽃피움은 어떤 형태인가?'
        ],
        styleSpecificNotes: '미래를 운명이 아닌 영혼의 선택과 의식 진화의 결과로 해석. 영적 비전, 사명 실현, 고차원적 목적 달성에 초점',
        timeframe: '영혼의 진화 시간표에 따른 장기적 영적 성장과 깨달음'
      }
    ],
    generalApproach: '삼위일체 조망의 시간 흐름을 영혼의 진화 과정으로 재해석하여, 과거의 영적 씨앗이 현재의 의식 거울을 통해 미래의 영혼 꽃피움으로 이어지는 신성한 여정으로 접근. 각 카드를 영적 교훈, 의식 확장, 내면 통합의 관점에서 깊이 있게 해석하며, 타로 리딩을 단순한 점술이 아닌 영혼의 자기 인식과 성장을 위한 신성한 거울로 활용',
    keyFocusAreas: [
      '영혼의 진화와 의식 확장 과정',
      '카르마적 교훈과 영적 숙제의 이해',
      '내면의 빛과 그림자 통합 작업',
    ...
    interpretationTips: [
      '각 카드의 영적 상징과 아키타입적 의미를 깊이 탐구하세요',
      '과거-현재-미래를 선형적 시간이 아닌 영혼의 나선형 진화로 이해하세요',
      '카드들 간의 영적 연결고리와 의식 진화의 패턴을 찾아내세요',
      '정립/역방향을 저항과 수용, 외적/내적 여정의 차이로 해석하세요',
      '숫자와 원소의 영적 의미를 적극 활용하여 깊이를 더하세요',
      '메이저 아르카나는 영혼의 큰 여정, 마이너 아르카나는 일상의 영적 실천으로 연결하세요',
      '구체적이고 실천 가능한 영적 성장 방법과 의식을 제안하세요',
      '희망과 가능성을 강조하되 현실적 노력과 실천의 필요성도 함께 제시하세요'
    ],
    commonPitfalls: [
      '영적 해석을 핑계로 현실 도피적 조언 제공',
      '추상적이고 모호한 영적 표현으로 구체성 부족',
      '카드의 그림자 측면을 회피하거나 과도하게 포장',
      '영적 우월감이나 특별함을 조장하는 해석',
      '개인적 성장보다 외적 기적이나 변화만 강조',
      '영적 여정의 어려움과 인내의 필요성 간과',
      '타인에 대한 판단이나 영적 계급의식 조장'
    ],
    difficulty: 'intermediate',
    estimatedTime: 25,
    createdAt: new Date(),
